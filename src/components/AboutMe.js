  ...
  return (
    <section id="aboutme" style={{ textAlign: 'center' }}>
      <div style={styles.container}>
        <h2>About Me</h2>
        <p>As a dedicated and enthusiastic computer science student at Queen’s University, I am eager to display my technical skills, academic achievements, and passion for software development. Currently pursuing a bachelor's degree in computer science, I have developed a solid foundation in JavaScript, Python, Java, HTML, Bash and CSS.</p>
