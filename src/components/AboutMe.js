  ...
  return (
    <section id="aboutme" style={{ textAlign: 'center' }}>
      <div style={styles.container}>
        <h2>About Me</h2>
        <p>As a dedicated and enthusiastic computer science student at Queen’s University, I am eager to bring my technical skills, academic achievements, and passion for software development to your team. Currently pursuing a bachelor's degree in computer science, I have developed a solid foundation in JavaScript, Python, Java, HTML, Bash and CSS.</p>
        <p>In addition to my academic pursuits, I am currently a Research Assistant at Queen’s University. In this role, I collaborate with two Master's students and one Postdoctoral researcher to evaluate the efficiency of different prompting methods when using LLMs (Large Language Models). Utilizing natural language processing techniques and large language models, I have contributed to automating the labeling process, enhancing efficiency and accuracy in our research endeavors.</p>
        <p>Additionally, my participation in Queen’s Women in Computing and QMIND has provided me with hands-on experience and honed my problem-solving abilities. One of my most rewarding experiences was redesigning the entire Queen’s Women in Computing Website and implementing it using React. This experience not only strengthened my technical skills but also taught me the importance of collaboration, communication, and adaptability in a team environment.</p>
